...
+ (NSDictionary *) makeSudoku {
    ...
    NSLog(@"initiating sudoku table and printing value %@", sudokuTable);
...
//                NSLog(@"%@",posibleValue);
                ...
                NSLog(@"print random value set for key %@, %d", rowcol, random);
            }
            //if ([random intValue] == 1) {
              //  NSLog(@"random value is 1");   
            //}    
    ...
    NSLog(@"end of make sudoku, initiating sudoku table and printing value %@", sudokuTable);
